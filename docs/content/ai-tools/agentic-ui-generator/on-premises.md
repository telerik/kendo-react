...
page_title: On-Premises Deployment - KendoReact Agentic UI Generator
description: 'Learn how to deploy the KendoReact Agentic UI Generator Context API stack on-premises using the provided Helm chart in your Kubernetes cluster.'
slug: agentic_ui_generator_on_premises
position: 15
tag: new
release_tag: Q3 2026
---
...
The KendoReact Agentic UI Generator supports on-premises deployment through a Helm chart that installs the Context API stack into your Kubernetes cluster. The deployment includes the Context API service, a bundled reranking service, and [Qdrant](https://qdrant.tech/) for vector storage.
...
> `CONTEXTAPI_URL` must follow the `host:port` format.
