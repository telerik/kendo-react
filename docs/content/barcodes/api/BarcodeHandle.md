---
title: BarcodeHandle
description: "Learn how to build custom functionality when working with the React Barcodes by Kendo UI with the help of the BarcodeHandle."
api_reference: true
type: inner_api
slug: api_barcodes_barcodehandle
---
...
Readonly&lt;[BarcodeProps]({% slug api_barcodes_barcodeprops %})&gt;
