...
[QRCodeProps]({% slug api_barcodes_qrcodeprops %}) [intersected](https://www.typescriptlang.org/docs/handbook/advanced-types.html#intersection-types) with RefAttributes&lt;[QRCodeHandle]({% slug api_barcodes_qrcodehandle %})&gt;
