---
title: ButtonItem
description: "Learn how to build custom functionality when working with the React Buttons by Kendo UI with the help of the ButtonItem."
api_reference: true
type: inner_api
slug: api_buttons_buttonitem
---
