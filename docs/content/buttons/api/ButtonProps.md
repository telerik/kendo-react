---
title: ButtonProps
description: "Learn how to build custom functionality when working with the React Buttons by Kendo UI with the help of the ButtonProps."
api_reference: true
type: inner_api
slug: api_buttons_buttonprops
---
