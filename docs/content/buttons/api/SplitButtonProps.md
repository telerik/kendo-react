...
description: "Learn how to build custom functionality when working with the React Buttons by Kendo UI with the help of the SplitButtonProps."
api_reference: true
type: inner_api
