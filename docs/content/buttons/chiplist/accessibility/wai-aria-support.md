...
page_title: KendoReact ChipList Documentation | ChipList  Accessibility
description: "Get started with the KendoReact ChipList and learn about its accessibility support for WAI-ARIA, Section 508, and WCAG 2.1."
tags: telerik,kendoreact,accessibility,wai-aria,wcag
slug: accessibility_chiplist
position: 100
---
...
Out of the box, the Kendo React ChipList provides extensive accessibility support and enables users with disabilities to acquire complete control over its features.
...
For more details about the ChipList component's keyboard navigation, refer to the article on [keyboard navigation in the ChipList component]({% slug keyboard_navigation_chiplist %}).
