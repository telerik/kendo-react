    ...
    return (
        <div>
            ...
            <div>
                ...
                <br />
                <div>
                    <Button svgIcon={heartIcon} type="button" disabled={isDisabled} />

                    <Button icon={'heart'} type="button" fillMode={'outline'} disabled={isDisabled} />

                    <Button iconClass={'fa fa-heart'} type="button" fillMode={'flat'} disabled={isDisabled} />
                </div>
            </div>
        </div>
    );
