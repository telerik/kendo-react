    ...
    return (
        <div>
            ...
            <ButtonGroup disabled={isDisabled}>
                <Button togglable={true} svgIcon={userIcon} themeColor={'primary'} disabled={isDisabled}>
                    User Mode
                </Button>
                <Button togglable={true} svgIcon={gearIcon} themeColor={'info'} disabled={isDisabled}>
                    Admin Mode
                </Button>
            </ButtonGroup>
        </div>
