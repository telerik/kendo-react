...
page_title: KendoReact Toolbar Documentation | Toolbar  Accessibility
description: "Get started with the KendoReact Toolbar and learn about its accessibility support for WAI-ARIA, Section 508, and WCAG 2.1."
tags: telerik,kendoreact,accessibility,wai-aria,wcag
slug: accessibility_toolbar
position: 100
---
...
For more details about the Toolbar component's keyboard navigation, refer to the article on [keyboard navigation in the Toolbar component]({% slug keyboard_navigation_toolbar %}).
