---
title: ChartLegendTitleProps
description: "Learn how to build custom functionality when working with the React Charts by Kendo UI with the help of the ChartLegendTitleProps."
api_reference: true
type: inner_api
slug: api_charts_chartlegendtitleprops
---
...
(args: [TitleVisualArgs]({% slug api_charts_titlevisualargs %})) => Element
