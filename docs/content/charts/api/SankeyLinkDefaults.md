---
title: SankeyLinkDefaults
description: "Learn how to build custom functionality when working with the React Charts by Kendo UI with the help of the SankeyLinkDefaults."
api_reference: true
type: inner_api
slug: api_charts_sankeylinkdefaults
---
...
[SankeyFocusHighlight]({% slug api_charts_sankeyfocushighlight %})
...
[SankeyLinkLabel]({% slug api_charts_sankeylinklabel %})
