...
const count = salesByQuarter.length;
export const salesByQuarterMissingValues = salesByQuarter.map((value, index) => ({
    ...value,
    count: index < 4 || index >= count - 5 || index === 20 ? null : value.count
}));
