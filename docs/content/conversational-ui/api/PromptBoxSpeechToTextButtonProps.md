---
title: PromptBoxSpeechToTextButtonProps
description: "Learn how to build custom functionality when working with the React Conversational UI by Kendo UI with the help of the PromptBoxSpeechToTextButtonProps."
api_reference: true
type: inner_api
slug: api_conversational-ui_promptboxspeechtotextbuttonprops
---
