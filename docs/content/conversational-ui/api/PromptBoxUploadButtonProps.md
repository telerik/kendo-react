...
description: "Learn how to build custom functionality when working with the React Conversational UI by Kendo UI with the help of the PromptBoxUploadButtonProps."
api_reference: true
type: inner_api
