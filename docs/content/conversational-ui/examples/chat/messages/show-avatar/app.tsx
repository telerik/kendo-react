...
const initialMessages: Message[] = [
    {
        id: 1,
        author: bot,
        text: 'Hello! Use the button above to toggle avatar visibility.',
        timestamp: new Date('2025-01-01T10:00:00Z')
    },
    {
        id: 2,
        author: user,
        text: 'The avatars help identify who sent each message.',
    ...
    return (
        <div style={{ height: '600px', maxWidth: '400px', margin: '0 auto' }}>
            <div style={{ marginBottom: '10px' }}>
                <Button onClick={() => setShowAvatar(!showAvatar)} themeColor="primary">
                    {showAvatar ? 'Hide' : 'Show'} Avatars
                </Button>
            </div>
