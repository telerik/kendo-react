---
title: Globalization
description: 'Globalize the KendoReact Chat in React projects by adapting to specific cultures, loading translated messages, or using the RTL support.'
components: ["aiprompt", "chat", "inlineaiprompt"]
slug: globalization_chat
position: 80
---
