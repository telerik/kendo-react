...
page_title: KendoReact Filter Documentation | Filter  Accessibility
description: "Get started with the KendoReact Filter and learn about its accessibility support for WAI-ARIA, Section 508, and WCAG 2.1."
tags: telerik,kendoreact,accessibility,wai-aria,wcag
slug: accessibility_filter
position: 100
---
...
Out of the box, the Kendo React Filter provides extensive accessibility support and enables users with disabilities to acquire complete control over its features.
...
For more details about the Filter component's keyboard navigation, refer to the article on [keyboard navigation in the Filter component]({% slug keyboard_navigation_filter %}).
