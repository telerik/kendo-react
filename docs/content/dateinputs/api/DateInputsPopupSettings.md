---
title: DateInputsPopupSettings
description: "Learn how to build custom functionality when working with the React Date Inputs by Kendo UI with the help of the DateInputsPopupSettings."
api_reference: true
type: inner_api
slug: api_dateinputs_dateinputspopupsettings
---
