...
description: "Learn how to build custom functionality when working with the React Date Inputs by Kendo UI with the help of the DateRangePickerCalendarSettings."
api_reference: true
type: inner_api
...
ComponentType&lt;[CalendarCellProps]({% slug api_dateinputs_calendarcellprops %})&gt;
...
ComponentType&lt;[CalendarHeaderTitleProps]({% slug api_dateinputs_calendarheadertitleprops %})&gt;
...
ComponentType&lt;[CalendarWeekCellProps]({% slug api_dateinputs_calendarweekcellprops %})&gt;
