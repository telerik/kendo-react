...
description: "Learn how to build custom functionality when working with the React Date Inputs by Kendo UI with the help of the ToggleButtonProps."
api_reference: true
type: inner_api
slug: api_dateinputs_togglebuttonprops
---
