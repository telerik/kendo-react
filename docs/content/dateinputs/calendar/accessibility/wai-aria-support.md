...
page_title: KendoReact Calendar Documentation | Calendar  Accessibility
description: "Get started with the KendoReact Calendar and learn about its accessibility support for WAI-ARIA, Section 508, and WCAG 2.1."
...
For more details about the Calendar component's keyboard navigation, refer to the article on [keyboard navigation in the Calendar component]({% slug keyboard_navigation_calendar %}).
