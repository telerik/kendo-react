...
page_title: KendoReact DateInput Documentation | DateInput  Accessibility
description: "Get started with the KendoReact DateInput and learn about its accessibility support for WAI-ARIA, Section 508, and WCAG 2.1."
tags: telerik,kendoreact,accessibility,wai-aria,wcag
slug: accessibility_dateinput
position: 100
---
...
Out of the box, the Kendo React DateInput provides extensive accessibility support and enables users with disabilities to acquire complete control over its features.
...
For more details about the DateInput component's keyboard navigation, refer to the article on [keyboard navigation in the DateInput component]({% slug keyboard_navigation_dateinput %}).
