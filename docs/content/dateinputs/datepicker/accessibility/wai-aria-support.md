...
page_title: KendoReact DatePicker Documentation | DatePicker  Accessibility
description: "Get started with the KendoReact DatePicker and learn about its accessibility support for WAI-ARIA, Section 508, and WCAG 2.1."
...
Out of the box, the Kendo React DatePicker provides extensive accessibility support and enables users with disabilities to acquire complete control over its features.
...
For more details about the DatePicker component's keyboard navigation, refer to the article on [keyboard navigation in the DatePicker component]({% slug keyboard_navigation_datepicker %}).
