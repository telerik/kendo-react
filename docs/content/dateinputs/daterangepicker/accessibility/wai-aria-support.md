...
page_title: KendoReact DateRangePicker Documentation | DateRangePicker  Accessibility
description: "Get started with the KendoReact DateRangePicker and learn about its accessibility support for WAI-ARIA, Section 508, and WCAG 2.1."
tags: telerik,kendoreact,accessibility,wai-aria,wcag
slug: accessibility_daterangepicker
position: 100
---
...
Out of the box, the Kendo React DateRangePicker provides extensive accessibility support and enables users with disabilities to acquire complete control over its features.
...
For more details about the DateRangePicker component's keyboard navigation, refer to the article on [keyboard navigation in the DateRangePicker component]({% slug keyboard_navigation_daterangepicker %}).
