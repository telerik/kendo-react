...
page_title: KendoReact DateTimePicker Documentation | DateTimePicker  Accessibility
description: "Get started with the KendoReact DateTimePicker and learn about its accessibility support for WAI-ARIA, Section 508, and WCAG 2.1."
tags: telerik,kendoreact,accessibility,wai-aria,wcag
slug: accessibility_datetimepicker
position: 100
---
...
Out of the box, the Kendo React DateTimePicker provides extensive accessibility support and enables users with disabilities to acquire complete control over its features.
...
[Calendar accessibility specification]({% slug accessibility_calendar %})
...
[ButtonGroup accessibility specification]({% slug accessibility_buttongroup %})
...
[TimePicker accessibility specification]({% slug accessibility_timepicker %})
...
For more details about the DateTimePicker component's keyboard navigation, refer to the article on [keyboard navigation in the DateTimePicker component]({% slug keyboard_navigation_datetimepicker %}).
