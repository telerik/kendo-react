...
page_title: KendoReact MultiViewCalendar Documentation | MultiViewCalendar  Accessibility
description: "Get started with the KendoReact MultiViewCalendar and learn about its accessibility support for WAI-ARIA, Section 508, and WCAG 2.1."
...
For more details about the MultiViewCalendar component's keyboard navigation, refer to the article on [keyboard navigation in the MultiViewCalendar component]({% slug keyboard_navigation_multiviewcalendar %}).
