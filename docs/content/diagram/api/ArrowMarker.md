---
title: ArrowMarker
description: "Learn how to build custom functionality when working with the React Diagram by Kendo UI with the help of the ArrowMarker."
api_reference: true
type: inner_api
slug: api_diagram_arrowmarker
---
...
Configuration options for the arrow marker
...
The path on which to position the arrow marker
