---
title: Circle
description: "Learn how to build custom functionality when working with the React Diagram by Kendo UI with the help of the Circle."
api_reference: true
type: inner_api
slug: api_diagram_circle
---
...
Configuration options for the circle
...
New options to apply to the circle
