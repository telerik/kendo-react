---
title: CircleMarker
description: "Learn how to build custom functionality when working with the React Diagram by Kendo UI with the help of the CircleMarker."
api_reference: true
type: inner_api
slug: api_diagram_circlemarker
---
...
The anchor point for positioning the marker.
...
(options: [ConnectionCap]({% slug api_diagram_connectioncap %}))
...
[ConnectionCap]({% slug api_diagram_connectioncap %})


</code>
Configuration options for the circle marker
...
The path on which to position the circle marker
