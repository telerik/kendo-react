---
title: Line
description: "Learn how to build custom functionality when working with the React Diagram by Kendo UI with the help of the Line."
api_reference: true
type: inner_api
slug: api_diagram_line
---
...
The drawing group container that holds the line and its markers.
...
Configuration options for the line including endpoints and styling
