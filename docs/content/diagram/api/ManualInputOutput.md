---
title: ManualInputOutput
description: "Learn how to build custom functionality when working with the React Diagram by Kendo UI with the help of the ManualInputOutput."
api_reference: true
type: inner_api
slug: api_diagram_manualinputoutput
---
...
Configuration options for the manual input/output shape
