...
description: "Learn how to build custom functionality when working with the React Diagram by Kendo UI with the help of the ManualOperation."
api_reference: true
type: inner_api
slug: api_diagram_manualoperation
---
...
Configuration options for the manual operation shape
