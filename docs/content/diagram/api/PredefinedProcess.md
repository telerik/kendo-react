---
title: PredefinedProcess
description: "Learn how to build custom functionality when working with the React Diagram by Kendo UI with the help of the PredefinedProcess."
api_reference: true
type: inner_api
slug: api_diagram_predefinedprocess
---
...
Configuration options for the predefined process shape
