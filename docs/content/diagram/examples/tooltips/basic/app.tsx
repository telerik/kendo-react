...
import { Group, TextBlock, Image, Process } from '@progress/kendo-diagram-common';
...
interface ShapeTooltipData {
    dataItem: EmployeeDataItem;
}

interface ConnectionTooltipData {
    from: string;
    to: string;
    tooltipText: string;
}
...
const App = () => {
    const diagramRef = React.useRef<{ bringIntoView: (shapes: unknown[]) => void; shapes: unknown[] } | null>(null);
    ...
    return (
        ...
        >
            ...
            <DiagramConnectionTooltip>
                {(dataItem: ConnectionTooltipData) => (
