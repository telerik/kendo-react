...
page_title: KendoReact Dialog Documentation | Dialog  Accessibility
description: "Get started with the KendoReact Dialog and learn about its accessibility support for WAI-ARIA, Section 508, and WCAG 2.1."
tags: telerik,kendoreact,accessibility,wai-aria,wcag
slug: accessibility_dialog
position: 100
---
...
For more details about the Dialog component's keyboard navigation, refer to the article on [keyboard navigation in the Dialog component]({% slug keyboard_navigation_dialog %}).
## See Also
