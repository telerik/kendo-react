...
page_title: KendoReact AutoComplete Documentation | AutoComplete  Accessibility
description: "Get started with the KendoReact AutoComplete and learn about its accessibility support for WAI-ARIA, Section 508, and WCAG 2.1."
tags: telerik,kendoreact,accessibility,wai-aria,wcag
slug: accessibility_autocomplete
position: 100
---
...
Out of the box, the Kendo React AutoComplete provides extensive accessibility support and enables users with disabilities to acquire complete control over its features.
...
For more details about the AutoComplete component's keyboard navigation, refer to the article on [keyboard navigation in the AutoComplete component]({% slug keyboard_navigation_autocomplete %}).
