...
page_title: KendoReact ComboBox Documentation | ComboBox  Accessibility
description: "Get started with the KendoReact ComboBox and learn about its accessibility support for WAI-ARIA, Section 508, and WCAG 2.1."
tags: telerik,kendoreact,accessibility,wai-aria,wcag
slug: accessibility_combobox
position: 100
---
...
For more details about the ComboBox component's keyboard navigation, refer to the article on [keyboard navigation in the ComboBox component]({% slug keyboard_navigation_combobox %}).
