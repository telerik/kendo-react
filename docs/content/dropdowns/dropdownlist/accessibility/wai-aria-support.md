...
page_title: KendoReact DropDownList Documentation | DropDownList  Accessibility
description: "Get started with the KendoReact DropDownList and learn about its accessibility support for WAI-ARIA, Section 508, and WCAG 2.1."
tags: telerik,kendoreact,accessibility,wai-aria,wcag
slug: accessibility_dropdownlist
position: 100
---
...
For more details about the DropDownList component's keyboard navigation, refer to the article on [keyboard navigation in the DropDownList component]({% slug keyboard_navigation_dropdownlist %}).
