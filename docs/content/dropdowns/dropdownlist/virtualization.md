...
description: 'Enable the virtual scrolling functionality of the KendoReact DropDownList in React projects.'
components: ["dropdownlist"]
slug: virtualization_dropdownlist
subject: Virtualization feature of DropDownList
position: 10001
tier: premium
---
...
To enable virtualization, configure [`onPageChange`]({% slug api_dropdowns_dropdownlistprops %}#toc-onpagechange) event and the composite [`virtual`]({% slug api_dropdowns_dropdownlistprops %}#toc-virtual) property which contains the following fields:
...
{% meta height:360 %}
{% embed_file dropdownlist/virtualization-basic/func/app.tsx preview %}
{% embed_file dropdownlist/virtualization-basic/func/main.tsx %}
{% endmeta %}
...
{% meta height:380 %}
{% embed_file dropdownlist/virtualization-filtering/func/app.tsx preview %}
{% embed_file dropdownlist/virtualization-filtering/func/main.tsx %}
{% endmeta %}
...
{% meta height:340 %}
{% embed_file dropdownlist/virtualization-grouping/func/app.tsx preview %}
{% embed_file dropdownlist/virtualization-grouping/func/main.tsx %}
{% endmeta %}
