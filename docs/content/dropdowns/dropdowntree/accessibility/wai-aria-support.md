...
page_title: KendoReact DropDownTree Documentation | DropDownTree  Accessibility
description: "Get started with the KendoReact DropDownTree and learn about its accessibility support for WAI-ARIA, Section 508, and WCAG 2.1."
tags: telerik,kendoreact,accessibility,wai-aria,wcag
slug: accessibility_dropdowntree
position: 100
---
...
Out of the box, the Kendo React DropDownTree provides extensive accessibility support and enables users with disabilities to acquire complete control over its features.
...
For more details about the DropDownTree component's keyboard navigation, refer to the article on [keyboard navigation in the DropDownTree component]({% slug keyboard_navigation_dropdowntree %}).
