...
const App = () => {
    const architecturalWonders = [
        ...
        { id: 2, name: 'Eiffel Tower', type: 'Modern Landmark' },
        { id: 3, name: 'Sydney Opera House', type: 'Modern Landmark' },
        { id: 4, name: 'Taj Mahal', type: 'Cultural Heritage' },
        { id: 5, name: 'Colossus of Rhodes', disabled: true, type: 'Destroyed Wonder' },
