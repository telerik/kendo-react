...
import { Form, Field, FormFieldSet, FormElement, FieldRenderProps, FieldWrapper } from '@progress/kendo-react-form';
...
const App = () => {
    ...
    const MultiSelectTreeField = (fieldRenderProps: FieldRenderProps) => {
        ...
        const value = Array.isArray(fieldValue) ? (fieldValue as any[]) : [];
        ...
        return (
            <MultiSelectTree
                ...
                validationMessage={visited ? validationMessage || undefined : undefined}
            />
        );
    };
