...
const isDecor = (items) => items && items.findIndex((item) => item.id > 4) > -1;
...
const App = () => {
    ...
    const [expanded, setExpanded] = React.useState([data[1][dataItemKey]]);
    ...
    const MultiSelectTreeField = (fieldRenderProps: FieldRenderProps) => {
        ...
        return (
            <MultiSelectTree
                ...
                validationMessage={visited && validationMessage ? String(validationMessage) : ''}
            />
        );
    };
