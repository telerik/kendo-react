...
To install the Dropdowns package, run the following command in the root folder of your React project:
...
Now try to add another component from the Dropdowns package yourself. The procedures for [installing](#install-the-component), [importing](#import-the-component), and [using](#use-the-component) the data tools components are identical for all components in the package.
