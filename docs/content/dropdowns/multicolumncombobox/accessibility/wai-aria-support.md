...
page_title: KendoReact MultiColumnComboBox Documentation | MultiColumnComboBox  Accessibility
description: "Get started with the KendoReact MultiColumnComboBox and learn about its accessibility support for WAI-ARIA, Section 508, and WCAG 2.1."
tags: telerik,kendoreact,accessibility,wai-aria,wcag
slug: accessibility_multicolumncombobox
position: 100
---
...
Out of the box, the Kendo React MultiColumnComboBox provides extensive accessibility support and enables users with disabilities to acquire complete control over its features.
...
[ComboBox accessibility specification]({% slug accessibility_combobox %})
...
For more details about the MultiColumnComboBox component's keyboard navigation, refer to the article on [keyboard navigation in the MultiColumnComboBox component]({% slug keyboard_navigation_multicolumncombobox %}).
