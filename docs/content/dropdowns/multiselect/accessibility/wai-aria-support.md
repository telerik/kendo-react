...
page_title: KendoReact MultiSelect Documentation | MultiSelect  Accessibility
description: "Get started with the KendoReact MultiSelect and learn about its accessibility support for WAI-ARIA, Section 508, and WCAG 2.1."
tags: telerik,kendoreact,accessibility,wai-aria,wcag
slug: accessibility_multiselect
position: 100
---
...
Out of the box, the Kendo React MultiSelect provides extensive accessibility support and enables users with disabilities to acquire complete control over its features.
...
For more details about the MultiSelect component's keyboard navigation, refer to the article on [keyboard navigation in the MultiSelect component]({% slug keyboard_navigation_multiselect %}).
