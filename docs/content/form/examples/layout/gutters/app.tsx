        ...
        <>
            ...
            <Form
                ...
                render={(formRenderProps: FormRenderProps) => (
                    <FormElement cols={2} gutters={{ rows: 5, cols: 10 }} style={{ maxWidth: 850 }}>
                        <FormFieldSet legend="Personal Information" cols={2} colSpan={1} gutters={{ rows: 4, cols: 6 }}>
                            <Field
                                colSpan={1}
                                name={'firstName'}
                                component={FormInput}
                        ...
                        <FormFieldSet legend="Reservation Details" cols={2} colSpan={1} gutters={{ rows: 4, cols: 6 }}>
                            <Field
                                colSpan={2}
                                id={'arrivalDate'}
                                name={'arrivalDate'}
