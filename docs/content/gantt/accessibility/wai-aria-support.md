...
page_title: KendoReact Gantt Documentation | Gantt  Accessibility
description: "Get started with the KendoReact Gantt and learn about its accessibility support for WAI-ARIA, Section 508, and WCAG 2.1."
tags: telerik,kendoreact,accessibility,wai-aria,wcag
slug: accessibility_gantt
position: 100
---
...
Out of the box, the Kendo React Gantt provides extensive accessibility support and enables users with disabilities to acquire complete control over its features.
...
[TreeList accessibility specification]({% slug accessibility_treelist %})


Another part of the component is the Splitter component and Wai-Aria support.

[Splitter accessibility specification]({% slug accessibility_splitter %})
...
For more details about the Gantt component's keyboard navigation, refer to the article on [keyboard navigation in the Gantt component]({% slug keyboard_navigation_gantt %}).
