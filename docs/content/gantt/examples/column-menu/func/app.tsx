...
import { ColumnMenuTextColumn, ColumnMenuDateColumn } from '@progress/kendo-react-data-tools';
...
const columns: GanttColumnProps[] = [
    ...
    { field: taskModelFields.title, title: 'Title', width: 200, expandable: true, columnMenu: ColumnMenuTextColumn },
    {
    ...
    { field: taskModelFields.end, title: 'End', width: 120, format: '{0:MM/dd/yyyy}', columnMenu: ColumnMenuDateColumn }
];
