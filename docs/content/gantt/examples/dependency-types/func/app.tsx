...
import { exampleDependencyTypeTaskData, exampleDependencyTypeDependencyData } from './shared-gt-data';
...
const App = () => {
    const [taskData] = React.useState(exampleDependencyTypeTaskData);
    const [dependencyData] = React.useState(exampleDependencyTypeDependencyData);
