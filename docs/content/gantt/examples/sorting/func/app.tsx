...
const App = () => {
    ...
    const [sort, setSort] = React.useState<any>([{ field: 'orderId', dir: 'asc' }]);

    const onSortChange = React.useCallback((event: GanttSortChangeEvent) => setSort(event.sort), [setSort]);
    ...
    const processedData = React.useMemo(() => {
        const sortedData = orderBy(taskData, sort, taskModelFields.children);
