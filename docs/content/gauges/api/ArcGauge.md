---
title: ArcGauge
description: "Learn how to build custom functionality when working with the React Gauges by Kendo UI with the help of the ArcGauge."
api_reference: true
type: inner_api
slug: api_gauges_arcgauge
---
