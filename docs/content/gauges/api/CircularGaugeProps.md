---
title: CircularGaugeProps
description: "Learn how to build custom functionality when working with the React Gauges by Kendo UI with the help of the CircularGaugeProps."
api_reference: true
type: inner_api
slug: api_gauges_circulargaugeprops
---
...
(value: number, color: string) => ReactElement&lt;any&gt;
...
[CircularScale]({% slug api_gauges_circularscale %})
