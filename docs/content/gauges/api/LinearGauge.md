---
title: LinearGauge
description: "Learn how to build custom functionality when working with the React Gauges by Kendo UI with the help of the LinearGauge."
api_reference: true
type: inner_api
slug: api_gauges_lineargauge
---
...
Readonly&lt;[LinearGaugeProps]({% slug api_gauges_lineargaugeprops %})&gt;
...
The props of the LinearGauge component.
