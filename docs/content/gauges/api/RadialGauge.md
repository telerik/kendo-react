---
title: RadialGauge
description: "Learn how to build custom functionality when working with the React Gauges by Kendo UI with the help of the RadialGauge."
api_reference: true
type: inner_api
slug: api_gauges_radialgauge
---
...
Readonly&lt;[RadialGaugeProps]({% slug api_gauges_radialgaugeprops %})&gt;
...
The props of the RadialGauge component.
