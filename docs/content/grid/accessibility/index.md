---
title: Overview
description: 'Get started with the KendoReact Grid and learn about its accessibility support for WCAG 2.2.'
components: ['grid']
...
The KendoReact Grid component is [WCAG 2.2 AA](https://www.w3.org/TR/WCAG22/) and [Section 508](http://www.section508.gov/) compliant. The component also follows the [WAI-ARIA best practices](https://www.w3.org/WAI/ARIA/apg/) for implementing the [keyboard navigation]({% slug keyboard_navigation_grid %}) for its component [role](https://www.w3.org/TR/wai-aria#roles), and is tested against the popular screen readers.
