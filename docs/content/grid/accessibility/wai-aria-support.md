...
page_title: KendoReact Grid Documentation | Grid  Accessibility
description: "Get started with the KendoReact Grid and learn about its accessibility support for WAI-ARIA, Section 508, and WCAG 2.1."
tags: telerik,kendoreact,accessibility,wai-aria,wcag
slug: accessibility_grid
position: 100
---
...
Out of the box, the Kendo React Grid provides extensive accessibility support and enables users with disabilities to acquire complete control over its features.
...
[Pager accessibility specification]({% slug accessibility_pager %})
...
For more details about the Grid component's keyboard navigation, refer to the article on [keyboard navigation in the Grid component]({% slug keyboard_navigation_grid %}).
