...
description: "Learn how to build custom functionality when working with the React Grid by Kendo UI with the help of the GridCustomFilterCellProps."
api_reference: true
type: inner_api
...
"null" | [GridTdAttributes]({% slug api_grid_gridtdattributes %})
