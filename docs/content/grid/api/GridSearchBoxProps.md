---
title: GridSearchBoxProps
description: "Learn how to build custom functionality when working with the React Grid by Kendo UI with the help of the GridSearchBoxProps."
api_reference: true
type: inner_api
slug: api_grid_gridsearchboxprops
---
...
(event: [GridSearchBoxChangeEvent]({% slug api_grid_gridsearchboxchangeevent %})) => void
