---
title: GridToolbarSortProps
description: "Learn how to build custom functionality when working with the React Grid by Kendo UI with the help of the GridToolbarSortProps."
api_reference: true
type: inner_api
slug: api_grid_gridtoolbarsortprops
---
