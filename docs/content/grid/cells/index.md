---
title: Overview
description: 'Get started with the KendoReact Grid and learn how to describe and customize the different cell types in React projects.'
components: ['grid']
slug: cells_grid
...
# KendoReact Grid Custom Cells Overview

The KendoReact Grid provides the option to override its internal components by allowing you to customize its different types of cells.

<CtaPanelOverview></CtaPanelOverview>

> Starting with KendoReact 5.14.0, you can apply more customizations to the Grid with a new set of properties. The previously available props such as the GridColumn [`cell`]({% slug api_grid_gridcolumnprops %}) prop or the Grid [`cellRender`]({% slug api_grid_gridprops %}) callback are deprecated as of version 9.4.0 of KendoReact.

## Getting Started with the KendoReact Grid Custom Cells
...
-   [Data Cells](slug:cells_grid#add-basic-custom-data-cells)
