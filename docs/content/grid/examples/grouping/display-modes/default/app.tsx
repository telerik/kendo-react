...
const App = () => {
    ...
    return (
        ...
        >
            ...
            <Column field="department" title="Department" width={180} />
            <Column field="officeLocation" title="Location" width={180} />
            <Column field="deviceType" title="Device Type" width={180} />
            <Column field="assetId" title="Asset ID" width={100} />
            <Column field="deviceModel" title="Device Model" width={260} />
            <Column field="assignedEmployee" title="Assignee" width={160} />
            <Column field="purchaseDate" title="Purchase Date" width={160} format="{0:yyyy-MM-dd}" />
