    ...
    return (
        <Grid
            ...
            groupable={{
                ...
                groupColumn: { width: 130, cells: { groupHeader: CustomGroupHeaderCell } },
        ...
        >
            ...
            <Column field="assignedEmployee" title="Assignee" width={130} />
            <Column field="purchaseDate" title="Purchase Date" width={120} format="{0:yyyy-MM-dd}" />
