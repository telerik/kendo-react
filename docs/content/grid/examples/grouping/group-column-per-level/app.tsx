...
import { Grid, GridColumn as Column, GridGroupColumnFn, GridCustomCellProps } from '@progress/kendo-react-grid';
...
const groupColumnCb: GridGroupColumnFn = (group) => ({
    width: group.field === 'department' ? 260 : 160,
    title: group.field === 'department' ? 'Department' : group.field === 'deviceType' ? 'Device Type' : '',
    reorderable: false,
