...
const generateNewPrice = (oldPrice: number) => {
...
const randomizeObjectData = (dataObj: any) => {
...
export const generateData = (count: number) => {
    ...
    for (let i = 0; i < count; i++) {
        const dataObj: any = Object.assign({}, DATA[i]);
...
export { randomizeObjectData, generateNewPrice };
