...
const PRESETS: Array<{ label: string; select: SelectDescriptor }> = [
    { label: products[0].ProductName, select: { [products[0].ProductID]: true } },
    { label: products[1].ProductName, select: { [products[1].ProductID]: true } }
];
...
const App = () => {
    ...
    const onSelectionChange = (event: GridSelectionChangeEvent) => {
        ...
        const newKey = Object.keys(newSelect).find((k) => newSelect[k]);
