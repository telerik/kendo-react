            ...
            >
                <GridToolbar>
                    <GridToolbarAIAssistant
                        ...
                        promptPlaceHolder="Export, Resize, Lock/Unlock, Show/Hide or Reorder with AI"
                        suggestionsList={[
                            'Export table as pdf',
                            'Resize Customer Name column to be 300px',
                            'Lock Customer Name column',
                            'Unlock Customer Name column',
                            'Show Customer Name column',
