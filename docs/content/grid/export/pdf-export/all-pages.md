...
description: 'Get started with the KendoReact Grid which supports the export of all pages to PDF.'
components: ['grid']
...
To export all pages of the KendoReact Grid, set the `data` property of the [`pdf`]({% slug api_grid_gridprops %}#toc-pdf) prop of the Grid.
