...
description: 'Learn how to apply global filtering in the KendoReact Grid to display only relevant records.'
components: ['grid']
...
# KendoReact Grid Basic Filtering

The KendoReact Grid provides a free global filtering feature that allows you to display only those Grid records which meet specified criteria.
...
-   [KendoReact Grid Advanced Filtering](slug:advanced_filtering_grid)
