---
title: Overview
page_title: 'React Grid RSC Mode Overview - KendoReact Docs & Demos'
description: 'Explore the capabilities and benefits of the RSC mode of the KendoReact Grid leveraging the React Server Components (RSC) architecture.'
components: ['grid']
...
The following example demonstrates the Grid running in RSC mode inside a Next.js app router page, where data operations are handled on the server without a `"use client"` directive.
...
[Read more about React Grid RSC Mode data operations...](slug:data_operations_rsc_grid)
...
[Read more about React Grid RSC Mode server actions...](slug:server_actions_rsc_grid)
...
[Read more about React Grid RSC Mode templates...](slug:templates_rsc_grid)
...
[Read more about React Grid RSC Mode selection...](slug:selection_rsc_grid)
...
[Read more about React Grid RSC Mode filtering...](slug:filtering_rsc_grid)
...
[Read more about React Grid RSC Mode sorting...](slug:sorting_rsc_grid)
...
[Read more about React Grid RSC Mode grouping...](slug:grouping_rsc_grid)
...
[Read more about React Grid RSC Mode paging...](slug:paging_rsc_grid)
...
[Read more about React Grid RSC Mode globalization...](slug:globalization_rsc_grid)

## Next Steps

-   [Getting Started with KendoReact Grid RSC Mode](slug:getstarted_rsc_grid)
