...
description: 'Get started with the KendoReact Grid package by KendoReact and learn more about sizing.'
components: ['grid']
slug: sizing_grid
position: 20
---
...
The KendoReact Grid enables you to reduce its density to achieve better visibility on smaller devices. For a compact appearance, you can change the value of the [`size`]({% slug api_grid_gridprops %}#toc-size) option to small. The compact Grid will utilize the available space by setting smaller padding in its cells.
