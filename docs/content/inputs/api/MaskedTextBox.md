---
title: MaskedTextBox
description: "Learn how to build custom functionality when working with the React Inputs by Kendo UI with the help of the MaskedTextBox."
api_reference: true
type: inner_api
slug: api_inputs_maskedtextbox
---
...
[MaskedTextBoxProps]({% slug api_inputs_maskedtextboxprops %}) [intersected](https://www.typescriptlang.org/docs/handbook/advanced-types.html#intersection-types) with RefAttributes&lt;any&gt;
...
The props of the MaskedTextBox component.
