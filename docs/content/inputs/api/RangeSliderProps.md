...
description: "Learn how to build custom functionality when working with the React Inputs by Kendo UI with the help of the RangeSliderProps."
api_reference: true
type: inner_api
slug: api_inputs_rangesliderprops
---
...
[Direction]({% slug api_inputs_direction %})
...
(event: [RangeSliderChangeEvent]({% slug api_inputs_rangesliderchangeevent %})) => void
