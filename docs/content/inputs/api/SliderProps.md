---
title: SliderProps
description: "Learn how to build custom functionality when working with the React Inputs by Kendo UI with the help of the SliderProps."
api_reference: true
type: inner_api
slug: api_inputs_sliderprops
---
...
(event: [SliderChangeEvent]({% slug api_inputs_sliderchangeevent %})) => void
