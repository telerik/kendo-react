...
page_title: KendoReact Checkbox Documentation | Checkbox  Accessibility
description: "Get started with the KendoReact Checkbox and learn about its accessibility support for WAI-ARIA, Section 508, and WCAG 2.1."
tags: telerik,kendoreact,accessibility,wai-aria,wcag
slug: accessibility_checkbox
position: 100
---
...
Out of the box, the Kendo React CheckBox provides extensive accessibility support and enables users with disabilities to acquire complete control over its features.
...
For more details about the Checkbox component's keyboard navigation, refer to the article on [keyboard navigation in the Checkbox component]({% slug keyboard_navigation_checkbox %}).
