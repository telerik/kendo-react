...
page_title: KendoReact ColorPicker Documentation | ColorPicker  Accessibility
description: "Get started with the KendoReact ColorPicker and learn about its accessibility support for WAI-ARIA, Section 508, and WCAG 2.1."
tags: telerik,kendoreact,accessibility,wai-aria,wcag
slug: accessibility_colorpicker
position: 100
---
...
Out of the box, the Kendo React ColorPicker provides extensive accessibility support and enables users with disabilities to acquire complete control over its features.
...
For more details about the ColorPicker component's keyboard navigation, refer to the article on [keyboard navigation in the ColorPicker component]({% slug keyboard_navigation_colorpicker %}).
