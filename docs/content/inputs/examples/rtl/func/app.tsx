...
const App = () => {
    ...
    return (
        <div className="row example-wrapper">
            ...
            <div className="col-12 col-md-6 example-col">
                <p>MaskedTextBox</p>
                <MaskedTextBox dir="rtl" mask="9-000" defaultValue="_-___" />
            </div>
            <div className="col-xs-12 col-md-6 example-col">
                <p>NumericTextBox</p>
                <NumericTextBox dir="rtl" defaultValue={value} format="c2" />
            </div>
            <div className="col-12 col-md-6 example-col">
                <p>Slider</p>
            ...
            <div className="col-12 col-md-6 example-col">
                <p>Checkbox</p>
                <Checkbox dir="rtl" label="Checkbox Option 1" defaultChecked={true} />
            </div>
            ...
            <div className="col-12 col-md-6 example-col">
                <p>OTPInput</p>
                <OTPInput dir="rtl" defaultValue="1234" />
            </div>
        </div>
    );
};
