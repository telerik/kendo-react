...
page_title: KendoReact RadioButton Documentation | RadioButton  Accessibility
description: "Get started with the KendoReact RadioButton and learn about its accessibility support for WAI-ARIA, Section 508, and WCAG 2.1."
tags: telerik,kendoreact,accessibility,wai-aria,wcag
slug: accessibility_radiobutton
position: 100
---
...
Out of the box, the Kendo React RadioButton provides extensive accessibility support and enables users with disabilities to acquire complete control over its features.
...
For more details about the RadioButton component's keyboard navigation, refer to the article on [keyboard navigation in the RadioButton component]({% slug keyboard_navigation_radiobutton %}).
