---
title: Selection
description: 'Sets the selection mode of the KendoReact Rating in React projects.'
components: ["rating"]
...
{% meta height:260 %}
{% embed_file rating/selection/func/app.tsx preview %}
{% embed_file rating/selection/func/main.tsx %}
{% endmeta %}
