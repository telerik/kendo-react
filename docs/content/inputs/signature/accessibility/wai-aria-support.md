...
page_title: KendoReact Signature Documentation | Signature  Accessibility
description: "Get started with the KendoReact Signature and learn about its accessibility support for WAI-ARIA, Section 508, and WCAG 2.1."
...
Out of the box, the Kendo React Signature provides extensive accessibility support and enables users with disabilities to acquire complete control over its features.
...
For more details about the Signature component's keyboard navigation, refer to the article on [keyboard navigation in the Signature component]({% slug keyboard_navigation_signature %}).
