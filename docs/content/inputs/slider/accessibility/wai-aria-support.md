...
page_title: KendoReact Slider Documentation | Slider  Accessibility
description: "Get started with the KendoReact Slider and learn about its accessibility support for WAI-ARIA, Section 508, and WCAG 2.1."
tags: telerik,kendoreact,accessibility,wai-aria,wcag
slug: accessibility_slider
position: 100
---
...
Out of the box, the Kendo React Slider provides extensive accessibility support and enables users with disabilities to acquire complete control over its features.
...
For more details about the Slider component's keyboard navigation, refer to the article on [keyboard navigation in the Slider component]({% slug keyboard_navigation_slider %}).
