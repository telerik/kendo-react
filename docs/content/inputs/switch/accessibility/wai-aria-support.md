...
page_title: KendoReact Switch Documentation | Switch  Accessibility
description: "Get started with the KendoReact Switch and learn about its accessibility support for WAI-ARIA, Section 508, and WCAG 2.1."
tags: telerik,kendoreact,accessibility,wai-aria,wcag
slug: accessibility_switch
position: 100
---
...
For more details about the Switch component's keyboard navigation, refer to the article on [keyboard navigation in the Switch component]({% slug keyboard_navigation_switch %}).
