...
page_title: KendoReact Textarea Documentation | Textarea  Accessibility
description: "Get started with the KendoReact Textarea and learn about its accessibility support for WAI-ARIA, Section 508, and WCAG 2.1."
...
Out of the box, the Kendo React TextArea provides extensive accessibility support and enables users with disabilities to acquire complete control over its features.
