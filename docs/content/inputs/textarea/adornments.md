---
title: Adornments
description: "Add custom items using adornments for the KendoReact TextArea component"
components: ["textarea"]
slug: adornments_textarea
position: 8
---
...
{% meta height:280 %}
{% embed_file textarea/customization/adornments/func/app.tsx preview %}
{% embed_file textarea/customization/adornments/func/main.tsx %}
{% endmeta %}
...
{% meta height:280 %}
{% embed_file textarea/customization/separator/func/app.tsx preview %}
{% embed_file textarea/customization/separator/func/main.tsx %}
{% endmeta %}
...
{% meta height:280 %}
{% embed_file textarea/customization/layout/func/app.tsx preview %}
{% embed_file textarea/customization/layout/func/main.tsx %}
{% endmeta %}
