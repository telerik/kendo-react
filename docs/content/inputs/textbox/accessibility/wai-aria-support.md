...
page_title: KendoReact Textbox Documentation | Textbox  Accessibility
description: "Get started with the KendoReact Textbox and learn about its accessibility support for WAI-ARIA, Section 508, and WCAG 2.1."
...
For more details about the Textbox component's keyboard navigation, refer to the article on [keyboard navigation in the Textbox component]({% slug keyboard_navigation_textbox %}).
