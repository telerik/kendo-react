...
{% meta height:420 %}
{% embed_file editor/add-span-with-class/app.tsx preview %}
{% embed_file editor/add-span-with-class/main.tsx %}
{% endmeta %}
...
{% meta height:420 %}
{% embed_file editor/add-non-editable-element/app.tsx preview %}
{% embed_file editor/add-non-editable-element/main.tsx %}
{% embed_file editor/add-non-editable-element/InsertShortcodeTool.tsx %}
{% endmeta %}
...
{% meta height:420 %}
{% embed_file editor/custom-font-size-tool/app.tsx preview %}
{% embed_file editor/custom-font-size-tool/main.tsx %}
{% embed_file editor/custom-font-size-tool/customFontSize.tsx %}
{% endmeta %}
...
{% meta height:420 %}
{% embed_file editor/custom-tools/app.tsx preview %}
{% embed_file editor/custom-tools/main.tsx %}
{% embed_file editor/custom-tools/backgroundColorTool.tsx %}
{% embed_file editor/custom-tools/clearAll.tsx %}
{% embed_file editor/custom-tools/myColorTool.tsx %}
{% endmeta %} -->
