...
<table>
    <tbody>
	    ...
	    <tr>
	    	<td>Product</td>
	    	<td>Progress® KendoReact ComboBox</td>
	    </tr>
    </tbody>
</table>
...
{% meta height:560 %}
{% embed_file dropdowns/combobox-open-on-focus-and-tab/app.tsx preview %}
{% embed_file dropdowns/combobox-open-on-focus-and-tab/main.tsx %}
{% endmeta %}
