    ...
    return (
        <Button
            onClick={() => {
                ...
                const textNode = state.schema.text('test');
                tr.addStoredMark(mark);
                tr.replaceSelectionWith(textNode, true);
                view.dispatch(tr);
            }}
            disabled={!canInsert}
...
const App = () => {
    return <Editor tools={[[EditorTools.Bold, InsertSpan]]} contentStyle={{ height: 300 }} defaultContent={content} />;
};
