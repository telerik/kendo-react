...
const App = () => {
    ...
    return (
        <>
            ...
            >
                <GridToolbar>
                    <div onClick={closeEdit}>
                        ...
                        <Button title="Add new column" className="k-button k-primary" onClick={addNewColumn}>
                            Add New Column
                        </Button>
                    </div>
                </GridToolbar>
            ...
            {state.openForm && <ColumnForm cancelEdit={handleCancelEdit} onSubmit={handleSubmit} />}
        </>
    );
};
