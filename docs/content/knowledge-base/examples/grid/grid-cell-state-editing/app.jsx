...
const TextCell = (props) => {
    ...
    if (props.dataItem.inEdit) {
        ...
        return (
            <td {...props.tdProps} onClick={() => currentContext.enterEdit(props.dataItem)}>
...
const NumberCell = (props) => {
    ...
    if (props.dataItem.inEdit) {
        return (
            <td {...props.tdProps}>
                <NumericTextBox value={value} onChange={handleChange} onBlur={handleBlur} />
            </td>
        );
    } else {
        return (
...
const App = () => {
    ...
    const enterEdit = (dataItem) => {
        ...
        const newData = data.map((item) =>
            item.ProductID === inEditID ? { ...item, inEdit: true } : { ...item, inEdit: false }
        );
        setData(newData);
    };
        ...
        <div>
            ...
            >
                ...
                >
                    ...
                    />
                    <Column field="ProductName" title="Product Name" width="300px" cells={{ data: TextCell }} />
                    <Column field="UnitsInStock" title="Units In Stock" cells={{ data: NumberCell }} />
                    <Column field="UnitsOnOrder" title="Units On Order" cells={{ data: NumberCell }} />
                </Grid>
            </MyContext.Provider>
        </div>
    );
