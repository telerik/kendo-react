...
const App = () => {
    ...
    const [filteredSampleProducts, setFilteredSampleProducts] = React.useState(sampleProducts);
    const [dataState, setDataState] = React.useState({
        skip: 0,
        take: 10
    });
    const [dataResult, setDataResult] = React.useState(process(filteredSampleProducts, dataState));
