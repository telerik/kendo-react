...
const items = [
    ...
    },
    {
        text: 'Notifications',
        svgIcon: bellIcon,
        route: '/drawer-kb-disable-item/notifications'
    },
    {
        text: 'Calendar',
        svgIcon: calendarIcon,
        route: '/drawer-kb-disable-item/calendar'
    },
    {
        separator: true
    },
    {
        text: 'Attachments',
        svgIcon: linkIcon,
        route: '/drawer-kb-disable-item/attachments'
    },
    {
        text: 'Favorites',
        svgIcon: heartIcon,
        route: '/drawer-kb-disable-item/favorites'
    }
];
