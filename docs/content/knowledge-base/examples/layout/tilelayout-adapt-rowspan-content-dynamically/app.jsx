...
const App = () => {
    ...
    const adjustRowSpanBasedOnContent = () => {
        ...
        setData((prevData) => prevData.map((item, index) => (index === 0 ? { ...item, rowSpan: newRowSpan } : item)));
    };
    ...
    const tiles = [
        {
            header: 'Page Views',
            body: <Grid maxHeight={500} data={products.slice(page.skip, page.take + page.skip)} />
        }
    ];
