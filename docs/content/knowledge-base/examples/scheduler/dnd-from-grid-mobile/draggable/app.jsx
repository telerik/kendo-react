...
import { DragAndDrop, useDroppable, Droppable } from '@progress/kendo-react-common';
...
const App = () => {
    ...
    const CustomRow = (props) => {
        return (
            <DraggableRow elementProps={props.trProps} {...props} >
                {props.children}
            </DraggableRow>
        );
    };
		...
		<ReorderContext.Provider value={{ dragStart: dragStart }}>
			<DragAndDrop>
				...
				<Grid
                    ...
                    rows={{ data: CustomRow }}
				>
					<Column title="" width="80px" cells={{ data: DragHandleCell }} />
