...
{% meta height:580 %}
{% embed_file grid/grid-filter-checkbox/app.tsx preview %}
{% embed_file grid/grid-filter-checkbox/main.tsx %}
{% embed_file grid/grid-filter-checkbox/customColumnMenu.tsx %}
{% endmeta %}
