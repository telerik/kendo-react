...
I want to alternate the Grid row colors. In addition, I also want to apply this color to the rows that belong to [locked]({% slug api_grid_gridcolumnprops %}#toc-locked) columns.
...
{% meta height:480 %}
{% embed_file grid/grid-row-colors/alternate-colors/app.jsx preview %}
{% embed_file grid/grid-row-colors/alternate-colors/main.jsx %}
{% endmeta %}
...
{% meta height:480 %}
{% embed_file grid/grid-row-colors/single-row-color/app.jsx preview %}
{% embed_file grid/grid-row-colors/single-row-color/main.jsx %}
{% endmeta %}
