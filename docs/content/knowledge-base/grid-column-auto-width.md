...
{% meta height:560 %}
{% embed_file grid/auto-width/canvas/app.tsx preview %}
{% embed_file grid/auto-width/canvas/main.tsx %}
{% endmeta %}
...
{% meta height:560 %}
{% embed_file grid/auto-width/calculate-size/app.tsx preview %}
{% embed_file grid/auto-width/calculate-size/main.tsx %}
{% endmeta %}
