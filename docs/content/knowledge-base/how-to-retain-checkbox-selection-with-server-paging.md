...
{% meta height:500 %}
{% embed_file grid/checkbox-selection-server-side/app.tsx preview %}
{% embed_file grid/checkbox-selection-server-side/main.tsx %}
{% embed_file grid/checkbox-selection-server-side/products-loader.tsx %}
{% endmeta %}
