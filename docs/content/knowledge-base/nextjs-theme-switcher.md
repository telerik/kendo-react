...
For the ThemeSwitcher, the most convenient component is the KendoReact [DropDownList]({% slug overview_dropdownlist %}) component. This is because it supports [grouping]({% slug overview_dropdownlist %}), rendering [custom items]({% slug customrendering_dropdownlist %}), and [binding]({% slug binding_dropdownlist %}) its data to an array of objects.
