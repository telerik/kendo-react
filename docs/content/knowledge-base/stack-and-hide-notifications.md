...
<table>
    <tbody>
	    ...
	    <tr>
	    	<td>Product</td>
	    	<td>Progress® KendoReact Notification</td>
	    </tr>
    </tbody>
</table>
...
{% meta  height:480 %}
{% embed_file notification/stack-and-hide-after/app.tsx preview %}
{% embed_file notification/stack-and-hide-after/main.tsx %}
{% endmeta %}
