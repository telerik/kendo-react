...
page_title: KendoReact ActionSheet Documentation | ActionSheet  Accessibility
description: "Get started with the KendoReact ActionSheet and learn about its accessibility support for WAI-ARIA, Section 508, and WCAG 2.1."
tags: telerik,kendoreact,accessibility,wai-aria,wcag
slug: accessibility_actionsheet
position: 100
---
...
Out of the box, the Kendo React ActionSheet provides extensive accessibility support and enables users with disabilities to acquire complete control over its features.
...
For more details about the ActionSheet component's keyboard navigation, refer to the article on [keyboard navigation in the ActionSheet component]({% slug keyboard_navigation_actionsheet %}).
