---
title: MenuItemProps
description: "Learn how to build custom functionality when working with the React Layout by Kendo UI with the help of the MenuItemProps."
api_reference: true
type: inner_api
slug: api_layout_menuitemprops
---
