...
page_title: KendoReact Appbar Documentation | Appbar  Accessibility
description: "Get started with the KendoReact Appbar and learn about its accessibility support for WAI-ARIA, Section 508, and WCAG 2.1."
tags: telerik,kendoreact,accessibility,wai-aria,wcag
slug: accessibility_appbar
position: 100
---
...
Out of the box, the Kendo React AppBar provides extensive accessibility support and enables users with disabilities to acquire complete control over its features.
...
For more details about the Appbar component's keyboard navigation, refer to the article on [keyboard navigation in the Appbar component]({% slug keyboard_navigation_appbar %}).
