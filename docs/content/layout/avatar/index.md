...
-   [Appearance]({% slug appearance_avatar %})&mdash;The Avatar comes with predefined option that allow you to set its shape, type, color, size, border, and fill.
