export const data = [
    {
        ...
        imageUrl: (import.meta.env.VITE_REACT_DEMOS_BASE_URL || '') + 'assets/layout/countries/brazil.jpg',
    ...
    },
    {
        ...
        country: 'Chile',
        continent: 'South America',
        imageUrl: (import.meta.env.VITE_REACT_DEMOS_BASE_URL || '') + 'assets/layout/countries/chile.jpg',
    ...
    },
    {
        ...
        country: 'Colombia',
        continent: 'South America',
        imageUrl: (import.meta.env.VITE_REACT_DEMOS_BASE_URL || '') + 'assets/layout/countries/colombia.jpg',
    ...
    },
    {
        ...
        country: 'Ecuador',
        continent: 'South America',
        imageUrl: (import.meta.env.VITE_REACT_DEMOS_BASE_URL || '') + 'assets/layout/countries/ecuador.jpg',
    ...
    },
    {
        ...
        country: 'Guyana',
        continent: 'South America',
        imageUrl: (import.meta.env.VITE_REACT_DEMOS_BASE_URL || '') + 'assets/layout/countries/guyana.jpg',
