...
page_title: KendoReact Menu Documentation | Menu  Accessibility
description: "Get started with the KendoReact Menu and learn about its accessibility support for WAI-ARIA, Section 508, and WCAG 2.1."
...
For more details about the Menu component's keyboard navigation, refer to the article on [keyboard navigation in the Menu component]({% slug keyboard_navigation_menu %}).
