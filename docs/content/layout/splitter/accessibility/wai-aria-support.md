...
page_title: KendoReact Splitter Documentation | Splitter  Accessibility
description: "Get started with the KendoReact Splitter and learn about its accessibility support for WAI-ARIA, Section 508, and WCAG 2.1."
tags: telerik,kendoreact,accessibility,wai-aria,wcag
slug: accessibility_splitter
position: 100
---
...
For more details about the Splitter component's keyboard navigation, refer to the article on [keyboard navigation in the Splitter component]({% slug keyboard_navigation_splitter %}).
