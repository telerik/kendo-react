...
page_title: KendoReact Stepper Documentation | Stepper  Accessibility
description: "Get started with the KendoReact Stepper and learn about its accessibility support for WAI-ARIA, Section 508, and WCAG 2.1."
tags: telerik,kendoreact,accessibility,wai-aria,wcag
slug: accessibility_stepper
position: 100
---
...
Out of the box, the Kendo React Stepper provides extensive accessibility support and enables users with disabilities to acquire complete control over its features.
...
For more details about the Stepper component's keyboard navigation, refer to the article on [keyboard navigation in the Stepper component]({% slug keyboard_navigation_stepper %}).
