...
page_title: KendoReact Tabstrip Documentation | Tabstrip  Accessibility
description: "Get started with the KendoReact Tabstrip and learn about its accessibility support for WAI-ARIA, Section 508, and WCAG 2.1."
...
Out of the box, the Kendo React TabStrip provides extensive accessibility support and enables users with disabilities to acquire complete control over its features.
...
For more details about the Tabstrip component's keyboard navigation, refer to the article on [keyboard navigation in the Tabstrip component]({% slug keyboard_navigation_tabstrip %}).
