...
page_title: KendoReact TileLayout Documentation | TileLayout  Accessibility
description: "Get started with the KendoReact TileLayout and learn about its accessibility support for WAI-ARIA, Section 508, and WCAG 2.1."
tags: telerik,kendoreact,accessibility,wai-aria,wcag
slug: accessibility_tilelayout
position: 100
---
...
Out of the box, the Kendo React TileLayout provides extensive accessibility support and enables users with disabilities to acquire complete control over its features.
...
For more details about the TileLayout component's keyboard navigation, refer to the article on [keyboard navigation in the TileLayout component]({% slug keyboard_navigation_tilelayout %}).
