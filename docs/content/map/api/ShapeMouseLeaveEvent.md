---
title: ShapeMouseLeaveEvent
description: "Learn how to build custom functionality when working with the React Map by Kendo UI with the help of the ShapeMouseLeaveEvent."
api_reference: true
type: inner_api
slug: api_map_shapemouseleaveevent
---
