...
page_title: KendoReact Notification Documentation | Notification  Accessibility
description: "Get started with the KendoReact Notification and learn about its accessibility support for WAI-ARIA, Section 508, and WCAG 2.1."
tags: telerik,kendoreact,accessibility,wai-aria,wcag
slug: accessibility_notification
position: 100
---
...
Out of the box, the Kendo React Notification provides extensive accessibility support and enables users with disabilities to acquire complete control over its features.
