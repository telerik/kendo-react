---
title: GridPDFExportProps
description: "Learn how to build custom functionality when working with the React PDF by Kendo UI with the help of the GridPDFExportProps."
api_reference: true
type: inner_api
slug: api_pdf_gridpdfexportprops
---
