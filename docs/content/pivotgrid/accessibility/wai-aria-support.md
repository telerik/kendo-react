...
page_title: KendoReact PivotGrid Documentation | PivotGrid  Accessibility
description: "Get started with the KendoReact PivotGrid and learn about its accessibility support for WAI-ARIA, Section 508, and WCAG 2.1."
tags: telerik,kendoreact,accessibility,wai-aria,wcag
slug: accessibility_pivotgrid
position: 100
---
...
For more details about the PivotGrid component's keyboard navigation, refer to the article on [keyboard navigation in the PivotGrid component]({% slug keyboard_navigation_pivotgrid %}).
