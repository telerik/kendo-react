---
title: PivotGridHeaderCellProps
description: "Learn how to build custom functionality when working with the React PivotGrid by Kendo UI with the help of the PivotGridHeaderCellProps."
api_reference: true
type: inner_api
slug: api_pivotgrid_pivotgridheadercellprops
---
...
[AxisDataItem]({% slug api_pivotgrid_axisdataitem %})
...
CustomComponent&lt;IconProps [intersected](https://www.typescriptlang.org/docs/handbook/advanced-types.html#intersection-types) with SvgIconProps&gt;
...
(args: KendoMouseEvent&lt;[PivotGridHeaderCellHandle]({% slug api_pivotgrid_pivotgridheadercellhandle %})&gt;) => void
