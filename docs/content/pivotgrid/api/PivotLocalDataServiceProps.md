---
title: PivotLocalDataServiceProps
description: "Learn how to build custom functionality when working with the React PivotGrid by Kendo UI with the help of the PivotLocalDataServiceProps."
api_reference: true
type: inner_api
slug: api_pivotgrid_pivotlocaldataserviceprops
---
...
(args: [PivotLocalDataServiceState]({% slug api_pivotgrid_pivotlocaldataservicestate %})) => any
...
{[key: string]: [Dimension]({% slug api_pivotgrid_dimension %})}
...
[Measure]({% slug api_pivotgrid_measure %})[]
