...
description: 'Get started with the KendoReact PivotGrid UI Component and learn how to set up the OLAP Cube when working with the widget.'
components: ["pivotgrid"]
slug: data-binding_olap-cube_pivotgrid
position: 2
---
...
> If you are not planning to access the cube from different domains, skip this step.
...
<table>
    <tbody>
        ...
        <tr>
            ...
            <td>
                <p>These are the names of the fields that must be used in the actual request. Values must be comma-separated.</p>
                <ul>
                    ...
                    <li><code>Content-Type</code> – this field indicates the content (MIME) type of the entity body sent to the recipient. The actual content type used in the communication between OLAP service and KendoReact <code>PivotDataSource</code> is text/xml.</li>
        ...
        <tr>
            ...
            <td>
                <p>The names of the allowed domains must be separated by comma (,).</p>
            </td>
        </tr>
        <tr>
...
-   Send the credentials with a request header even though the **Username** and **Password** will be visible on the client side (browser).

## Suggested Links

-   [Basic Usage of the PivotGrid]({% slug overview_pivotgrid %})
