...
description: "Get started with the KendoReact PivotGrid UI Component and review all fundamental concepts related to the widget."
components: ["pivotgrid"]
slug: data-binding_olap-fundamentals_pivotgrid
position: 1
---
...
The OLAP cube is a dataset that is organized in a multidimensional manner. Every cube has 0 (zero) or more dimensions. The cube allows the execution of different operations which answer complex analytical queries. The OLAP cube introduces concepts like facts, measures, and dimensions.
