---
title: PopupProps
description: "Learn how to build custom functionality when working with the React Popup by Kendo UI with the help of the PopupProps."
api_reference: true
type: inner_api
...
[Collision]({% slug api_popup_collision %})
...
(event: [PositionEvent]({% slug api_popup_positionevent %})) => void
