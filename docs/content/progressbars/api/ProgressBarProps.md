...
description: "Learn how to build custom functionality when working with the React ProgressBars by Kendo UI with the help of the ProgressBarProps."
api_reference: true
type: inner_api
...
React.ComponentType&lt;[LabelProps]({% slug api_progressbars_labelprops %})&gt;
