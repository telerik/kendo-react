---
title: Overview
description: 'Use the Kendo UI Productivity Tools for Visual Studio Code to speed up the configuration and deployment of the KendoReact components.'
components: ["general"]
