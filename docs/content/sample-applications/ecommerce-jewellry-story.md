...
Whether you are looking for examples how to use KendoReact in applications, or for a starting point for your own online shops, head over to the live [Ecommerce Jewellery Store Application](https://telerik.github.io/kendo-react/ecommerce-jewellery-store/). You can find [the Vite application's source code on GitHub](https://github.com/telerik/kendo-react/tree/master/examples/ecommerce-jewellery-store) and [the Astro application's source code on GitHub](https://github.com/telerik/kendo-react/tree/master/examples/kendo-react-e-commerce-astro-app)
...
1. Open `http://localhost:5173` to view the Vite Ecommerce app.
1. Open `http://localhost:4321` to view the Astro Ecommerce app.
