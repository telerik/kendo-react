...
page_title: KendoReact Scheduler Documentation | Scheduler  Accessibility
description: "Get started with the KendoReact Scheduler and learn about its accessibility support for WAI-ARIA, Section 508, and WCAG 2.1."
tags: telerik,kendoreact,accessibility,wai-aria,wcag
slug: accessibility_scheduler
position: 100
---
...
For more details about the Scheduler component's keyboard navigation, refer to the article on [keyboard navigation in the Scheduler component]({% slug keyboard_navigation_scheduler %}).
