---
title: SchedulerEditItemDragItemContext
description: "Learn how to build custom functionality when working with the React Scheduler by Kendo UI with the help of the SchedulerEditItemDragItemContext."
api_reference: true
type: inner_api
slug: api_scheduler_scheduleredititemdragitemcontext
---
...
ProviderProps&lt;[SchedulerEditItemDragItemContextType]({% slug api_scheduler_scheduleredititemdragitemcontexttype %})&gt;
...
The props of the SchedulerEditItemDragItemContext component.
