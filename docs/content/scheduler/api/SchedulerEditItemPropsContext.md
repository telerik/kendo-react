---
title: SchedulerEditItemPropsContext
description: "Learn how to build custom functionality when working with the React Scheduler by Kendo UI with the help of the SchedulerEditItemPropsContext."
api_reference: true
type: inner_api
...
ProviderProps&lt;[SchedulerEditItemProps]({% slug api_scheduler_scheduleredititemprops %})&gt;
...
The props of the SchedulerEditItemPropsContext component.
