---
title: SchedulerEditSlotPropsContext
description: "Learn how to build custom functionality when working with the React Scheduler by Kendo UI with the help of the SchedulerEditSlotPropsContext."
api_reference: true
type: inner_api
slug: api_scheduler_schedulereditslotpropscontext
---
...
ProviderProps&lt;[SchedulerEditSlotProps]({% slug api_scheduler_schedulereditslotprops %})&gt;
...
The props of the SchedulerEditSlotPropsContext component.
