...
description: "Learn how to build custom functionality when working with the React Scheduler by Kendo UI with the help of the SchedulerEditTaskProps."
api_reference: true
type: inner_api
...
React.ComponentType&lt;[SchedulerViewTaskProps]({% slug api_scheduler_schedulerviewtaskprops %})&gt;
