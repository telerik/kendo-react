---
title: SchedulerFieldsContext
description: "Learn how to build custom functionality when working with the React Scheduler by Kendo UI with the help of the SchedulerFieldsContext."
api_reference: true
type: inner_api
slug: api_scheduler_schedulerfieldscontext
---
...
ProviderProps&lt;[Fields]({% slug api_scheduler_fields %})&gt;
...
The props of the SchedulerFieldsContext component.
