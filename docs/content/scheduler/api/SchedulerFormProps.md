---
title: SchedulerFormProps
description: "Learn how to build custom functionality when working with the React Scheduler by Kendo UI with the help of the SchedulerFormProps."
api_reference: true
type: inner_api
slug: api_scheduler_schedulerformprops
---
...
React.ComponentType&lt;[SchedulerFormEditorProps]({% slug api_scheduler_schedulerformeditorprops %})&gt;
...
(event: [SchedulerFormStateChangeEvent]({% slug api_scheduler_schedulerformstatechangeevent %})&lt;null&gt;) => void
