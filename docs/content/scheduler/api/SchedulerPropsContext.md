---
title: SchedulerPropsContext
description: "Learn how to build custom functionality when working with the React Scheduler by Kendo UI with the help of the SchedulerPropsContext."
api_reference: true
type: inner_api
slug: api_scheduler_schedulerpropscontext
---
...
ProviderProps&lt;[SchedulerProps]({% slug api_scheduler_schedulerprops %})&gt;
...
The props of the SchedulerPropsContext component.
