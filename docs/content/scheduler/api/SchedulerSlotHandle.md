---
title: SchedulerSlotHandle
description: "Learn how to build custom functionality when working with the React Scheduler by Kendo UI with the help of the SchedulerSlotHandle."
api_reference: true
type: inner_api
...
[SchedulerSlotProps]({% slug api_scheduler_schedulerslotprops %})
