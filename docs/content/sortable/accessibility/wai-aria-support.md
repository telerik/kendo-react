...
page_title: KendoReact Sortable Documentation | Sortable  Accessibility
description: "Get started with the KendoReact Sortable and learn about its accessibility support for WAI-ARIA, Section 508, and WCAG 2.1."
tags: telerik,kendoreact,accessibility,wai-aria,wcag
slug: accessibility_sortable
position: 100
---
...
Out of the box, the Kendo React Sortable provides extensive accessibility support and enables users with disabilities to acquire complete control over its features.
...
For more details about the Sortable component's keyboard navigation, refer to the article on [keyboard navigation in the Sortable component]({% slug keyboard_navigation_sortable %}).
