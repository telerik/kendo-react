---
title: SpreadsheetHandle
description: "Learn how to build custom functionality when working with the React Spreadsheet by Kendo UI with the help of the SpreadsheetHandle."
api_reference: true
type: inner_api
slug: api_spreadsheet_spreadsheethandle
---
...
"null" | [SpreadsheetWidget]({% slug api_spreadsheet_spreadsheetwidget %})
...
[SpreadsheetProps]({% slug api_spreadsheet_spreadsheetprops %})
