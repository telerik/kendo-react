...
description: 'Quick setup guide for integrating Telerik and Kendo UI Themes with Tailwind CSS in KendoReact projects.'
components: ["general"]
slug: tailwind_getting_started
position: 10
---

# Getting Started with KendoReact and Tailwind CSS

Get started with your Tailwind CSS and KendoReact integration by following these simple steps.

## Prerequisites

In your [KendoReact project](slug:getting_started) verify that you have:

-   [Installed Tailwind CSS](https://tailwindcss.com/docs/installation) in your project.
-   [Installed a Kendo UI Theme](https://www.telerik.com/design-system/docs/themes/get-started/installation/) of your choice.

## Set Up Integration

You can map the [Progress Design System tokens](https://www.telerik.com/design-system/docs/foundation/guides/design-tokens/design-token-types/) to Tailwind CSS classes by adding the following CSS at the **top** of your root CSS file, usually `src/index.css` or `src/app.css` based on your configuration. If you add customizations later, place them **after** the token mappings.
...
After adding the above CSS to your application, you can use Progress Design System tokens in your Tailwind CSS classes:
...
function App() {
    return (
        <div className="bg-app-surface p-6 rounded-lg">
            <h1 className="text-lg font-bold text-primary-on-surface mb-4">Welcome to KendoReact</h1>
            <Button className="mb-4">Themed Button</Button>
            <div className="bg-primary border-2 border-solid border-secondary rounded-lg p-4">
                <p className="text-on-primary">Using Progress Design System colors</p>
            </div>
        </div>
    );
}
...
-   [Customizing KendoReact Components with Tailwind CSS](slug:tailwind_customization)
