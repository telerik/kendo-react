---
title: TaskBoardAddCardProps
description: "Learn how to build custom functionality when working with the React TaskBoard by Kendo UI with the help of the TaskBoardAddCardProps."
api_reference: true
type: inner_api
slug: api_taskboard_taskboardaddcardprops
---
