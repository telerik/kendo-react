...
import {
    TaskBoard, TaskBoardToolbar, TaskBoardChangeEvent,
    TaskBoardColumnModel, TaskBoardTaskModel, TaskBoardPriority
...
const App = () => {
    ...
    const onAddColumn = () => {
        const newColumn: TaskBoardColumnModel = { id: columnsData.length + 1, title: 'New Column', status: 'new', edit: true };
    ...
    return (
      ...
      >
        <TaskBoardToolbar>
          <Button svgIcon={plusIcon} onClick={onAddColumn}>Add Column</Button>
