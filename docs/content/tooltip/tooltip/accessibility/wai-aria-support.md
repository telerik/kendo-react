...
page_title: KendoReact Tooltip Documentation | Tooltip  Accessibility
description: "Get started with the KendoReact Tooltip and learn about its accessibility support for WAI-ARIA, Section 508, and WCAG 2.1."
tags: telerik,kendoreact,accessibility,wai-aria,wcag
slug: accessibility_tooltip
position: 100
---
...
Out of the box, the Kendo React Tooltip provides extensive accessibility support and enables users with disabilities to acquire complete control over its features.
...
For more details about the Tooltip component's keyboard navigation, refer to the article on [keyboard navigation in the Tooltip component]({% slug keyboard_navigation_tooltip %}).
