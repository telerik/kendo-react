---
title: TreeListCellProps
description: "Learn how to build custom functionality when working with the React TreeList by Kendo UI with the help of the TreeListCellProps."
api_reference: true
type: inner_api
slug: api_treelist_treelistcellprops
---
