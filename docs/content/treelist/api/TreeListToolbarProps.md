---
title: TreeListToolbarProps
description: "Learn how to build custom functionality when working with the React TreeList by Kendo UI with the help of the TreeListToolbarProps."
api_reference: true
type: inner_api
slug: api_treelist_treelisttoolbarprops
---
