...
page_title: KendoReact TreeView Documentation | TreeView  Accessibility
description: "Get started with the KendoReact TreeView and learn about its accessibility support for WAI-ARIA, Section 508, and WCAG 2.1."
tags: telerik,kendoreact,accessibility,wai-aria,wcag
slug: accessibility_treeview
position: 100
---
...
For more details about the TreeView component's keyboard navigation, refer to the article on [keyboard navigation in the TreeView component]({% slug keyboard_navigation_treeview %}).
