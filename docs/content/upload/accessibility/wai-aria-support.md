...
page_title: KendoReact Upload Documentation | Upload  Accessibility
description: "Get started with the KendoReact Upload and learn about its accessibility support for WAI-ARIA, Section 508, and WCAG 2.1."
...
Out of the box, the Kendo React Upload provides extensive accessibility support and enables users with disabilities to acquire complete control over its features.
...
For more details about the Upload component's keyboard navigation, refer to the article on [keyboard navigation in the Upload component]({% slug keyboard_navigation_upload %}).
