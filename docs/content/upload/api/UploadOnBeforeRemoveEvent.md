---
title: UploadOnBeforeRemoveEvent
description: "Learn how to build custom functionality when working with the React Upload by Kendo UI with the help of the UploadOnBeforeRemoveEvent."
api_reference: true
type: inner_api
slug: api_upload_uploadonbeforeremoveevent
---
...
[UploadAdditionalData]({% slug api_upload_uploadadditionaldata %})
