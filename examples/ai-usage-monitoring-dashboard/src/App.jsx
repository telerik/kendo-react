...
function App() {
  ...
  const filteredRows = useMemo(() => {
    ...
    return rows.filter((item) => {
      ...
      const matchesSearch =
        !lowerSearch ||
        [item.model, item.team, item.project].some((v) =>
    ...
    <div className={`app-shell ${theme}`}>
      <section className="topbar" aria-label="Dashboard controls">
        ...
        <div className="topbar-actions">
          ...
          <Button themeColor="primary" onClick={exportFullReport}>
            Export report
          </Button>
        </div>
      </section>
      ...
      <section className="table-section" aria-label="Detailed usage records">
        <div className="table-header">
          ...
          <Button themeColor="primary" onClick={exportCsv}>
            Export CSV
          </Button>
        </div>
        <Grid
      ...
      <section className="dashboard-grid">
        ...
        >
          ...
          <CardBody>
            <Chart>
              <ChartTitle text="API calls by day" />
              <ChartLegend position="bottom" />
              <ChartCategoryAxis>
                <ChartCategoryAxisItem categories={usageLabels} />
              </ChartCategoryAxis>
              <ChartValueAxis>
                <ChartValueAxisItem />
              </ChartValueAxis>
        ...
        >
          ...
          <CardBody>
            <Chart>
              <ChartTitle text="Spend by model" />
              <ChartLegend position="bottom" />
              <ChartSeries>
                <ChartSeriesItem
                  type="donut"
