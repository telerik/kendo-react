            ...
            <div className="content">
                    ...
                    <h2>Master the Art of React UI</h2>
                        <div className="button-group">
                            <Button themeColor={"primary"} rounded={"small"} onClick={()=>{window.open("https://www.telerik.com/download-login-v2-kendo-react-ui")}}>{localizationService.toLanguageString('custom.startFreeTrial', noMessage)}</Button>
                            <Button rounded={"small"} onClick={()=>{window.open("https://www.telerik.com/kendo-react-ui/#pricing")}}>{localizationService.toLanguageString('custom.buyNow', noMessage)}</Button>
                        </div>

                        <a className="github-link" href="https://github.com/telerik/react-coffee-warehouse">
                            <img src={github} alt="github icon" />
                            <span className="github-text">
                                {localizationService.toLanguageString('custom.getSource', noMessage)}
                            </span>
                        </a>
                    </div>
