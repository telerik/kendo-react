export const enMessages = {
  custom: {
    ...
    dashboardDescription:
      "A clear view of team performance, activity, and tracked order value.",
    dashboardSummary: "Dashboard summary",
    sampleDetails: "Sample details",
    samplePeriod: "Sample period · Jan 1 – Apr 29, 2020",
    lastUpdated: "Updated for the latest sample data",
    ordersTracked: "Orders tracked",
    ordersTrackedDescription: "Across the current sample",
    onlineMembers: "Online team members",
    onlineMembersDescription: "Available for warehouse work",
    orderValue: "Tracked order value",
    orderValueDescription: "Total value in the sample",
    warehouseOperations: "Warehouse operations",
    toggleNavigation: "Toggle warehouse navigation",
