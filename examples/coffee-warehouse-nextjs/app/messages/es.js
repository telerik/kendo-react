export const esMessages = {
  custom: {
    ...
    dashboardDescription:
      "Una vista clara del rendimiento del equipo, la actividad y el valor de los pedidos registrados.",
    dashboardSummary: "Resumen del tablero",
    sampleDetails: "Detalles de la muestra",
    samplePeriod: "Período de muestra · 1 ene – 29 abr 2020",
    lastUpdated: "Actualizado con los datos de muestra más recientes",
    ordersTracked: "Pedidos registrados",
    ordersTrackedDescription: "En la muestra actual",
    onlineMembers: "Miembros del equipo conectados",
    onlineMembersDescription: "Disponibles para el trabajo del almacén",
    orderValue: "Valor de pedidos registrado",
    orderValueDescription: "Valor total de la muestra",
    warehouseOperations: "Operaciones del almacén",
    toggleNavigation: "Alternar navegación del almacén",
    ...
    demoInfo:
      "Esta aplicación de demostración está construida utilizando los siguientes componentes de KendoReact y el tema predeterminado de KendoReact.",
  ...
  scheduler: {
    ...
    editorRecurringConfirmation:
      "¿Desea editar solo este evento o la serie completa?",
    ...
    deleteRecurringConfirmation:
      "¿Desea eliminar solo este evento o la serie completa?",
