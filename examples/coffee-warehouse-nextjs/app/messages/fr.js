export const frMessages = {
  custom: {
    ...
    dashboardDescription:
      "Une vue claire des performances de l'équipe, de l'activité et de la valeur des commandes suivies.",
    dashboardSummary: "Résumé du tableau de bord",
    sampleDetails: "Détails de l'échantillon",
    samplePeriod: "Période d'échantillon · 1 janv. – 29 avr. 2020",
    lastUpdated: "Mis à jour avec les dernières données d'exemple",
    ordersTracked: "Commandes suivies",
    ordersTrackedDescription: "Dans l'échantillon actuel",
    onlineMembers: "Membres de l'équipe en ligne",
    onlineMembersDescription: "Disponibles pour les opérations",
    orderValue: "Valeur des commandes suivies",
    orderValueDescription: "Valeur totale de l'échantillon",
    warehouseOperations: "Opérations de l'entrepôt",
    toggleNavigation: "Afficher la navigation de l'entrepôt",
  ...
  scheduler: {
    ...
    editorRecurringConfirmation:
      "Voulez-vous modifier uniquement cette occurrence d'événement ou toute la série?",
    ...
    deleteRecurringConfirmation:
      "Souhaitez-vous supprimer uniquement cette occurrence d'événement ou toute la série?",
