export const es = {
    ...
    noResultsTitle: "Ningún artículo coincide con esos filtros",
    noResultsMessage: "Quita un filtro para ver más piezas de la colección Vilora.",
    ratingLabel: "Valoración",
    outOfFiveLabel: "sobre 5",
    reviewsLabel: "reseñas",
    inStockLabel: "En stock",
    lowStockLabel: "Solo quedan",
