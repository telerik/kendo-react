export const fr = {
    ...
    noResultsTitle: "Aucun article ne correspond à ces filtres",
    noResultsMessage: "Supprimez un filtre pour voir davantage de la collection Vilora.",
    ratingLabel: "Note",
    outOfFiveLabel: "sur 5",
    reviewsLabel: "avis",
    inStockLabel: "En stock",
    lowStockLabel: "Plus que",
